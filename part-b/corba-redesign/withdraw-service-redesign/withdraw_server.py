...
import CORBA, Withdraw, Withdraw__POA

class BankingServer(Withdraw__POA.BankingServer):
    def withdraw(self, email, password, account, amount):
        ...
        if amount <= 0:
            return "Cannot withdraw no or a negative amount of money into the account"
        ...
        try:
            ...
            if password != database_password:
                ...
                return 'Insuffient funds to withdraw {amount}'.format(amount = amount)
